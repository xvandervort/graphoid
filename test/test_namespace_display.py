...
class TestNamespaceDisplay:
    ...
    def test_namespace_after_variable_declaration(self):
        ...
        assert variables['name']['display'] == "Alice"
        assert variables['age']['display'] == "25"
    ...
    def test_namespace_after_file_load(self):
        ...
        try:
            ...
            # Verify values
            assert variables['greeting']['display'] == "Hello from file"
            assert variables['value']['display'] == "42"
            assert variables['items']['display'] == "[a, b, c]"
    ...
    def test_namespace_preserves_existing_variables_after_load(self):
        ...
        try:
            ...
            assert variables['local_var']['display'] == "local"
            assert variables['local_num']['display'] == "100"
            
            # File variables should be added
            assert 'file_var' in variables
            assert 'file_num' in variables
            assert variables['file_var']['display'] == "from file"
            assert variables['file_num']['display'] == "200"
    ...
    def test_namespace_after_failed_file_load(self):
        ...
        assert variables['test_var']['display'] == "should remain"
    ...
    def test_namespace_after_partial_file_load(self):
        ...
        try:
            ...
            # Verify values
            assert variables['original']['display'] == "original"
            assert variables['good_var']['display'] == "this works"
